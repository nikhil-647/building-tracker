              ...
              <div key={day.date} className="bg-gradient-to-r from-muted/30 to-muted/10 p-4 rounded-xl border border-border/50 hover:border-border transition-all duration-200">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-6">
                      <div className="flex items-center space-x-2 bg-emerald-50 dark:bg-emerald-950/30 px-3 py-1.5 rounded-full">
                      ...
                      <div className="flex items-center space-x-2 bg-teal-50 dark:bg-teal-950/30 px-3 py-1.5 rounded-full">
                  ...
                  <div className="text-right">
                    <div className="text-lg font-bold text-primary">{day.totalMinutes}m</div>
                ...
                <div className="mt-3">
                  <div className="flex justify-between text-xs text-muted-foreground mb-1">
                    ...
                    <span>{Math.round((day.totalMinutes / 90) * 100)}%</span>
                  </div>
